                ...
                <AnimatePresence>
                    {isOpen && (
                        <motion.div
                            ...
                            className="absolute p-3 z-20 mt-1 w-full bg-white border border-gray-300 rounded-lg shadow-lg"
                        >
                                        ...
                                        {isSearchable && (
                                            <div className="relative my-2">
                                                <input
                                                    ...
                                                    className="w-full border border-gray-300 rounded-full px-3 py-1.5 text-sm placeholder:text-xs focus:outline-none focus:border-indigo-300"
                                                />
                                                {searchTerm && (
                                                    <button
                                                        type="button"
