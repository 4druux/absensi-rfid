...
const useInputSiswaForm = () => {
    const [formData, setFormData] = useState({
        ...
        kelas_id: "",
        new_kelas: null,
        students: [{ id: Date.now(), rfid: "", nama: "", jenis_kelamin: "" }],
    });
    ...
    const addStudentRow = () => {
        setFormData((prev) => ({
            ...
            students: [
                ...prev.students,
                { id: Date.now(), rfid: "", nama: "", jenis_kelamin: "" },
            ],
        }));
    };
            ...
            .map((row, index) => {
                ...
                return {
                    ...
                    nama: (
                        ...
                        .trim()
                        .toUpperCase(),
                    rfid: (row["RFID"] || row["rfid"] || row["Rfid"] || "")
                        .toString()
                        .trim(),
                    jenis_kelamin: jenis_kelamin,
                };
            })
            .filter((s) => s.rfid && s.nama)
    ...
    const handleSubmit = async (e) => {
        ...
        const validStudents = formData.students.filter(
            (s) => s.nama && s.rfid && s.jenis_kelamin
        );
